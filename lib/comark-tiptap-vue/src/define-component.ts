...
export function defineComarkVueComponent(
  ...
  // Build the framework-agnostic part first — it produces the schema
  // and the serialization spec. We then extend the resulting Tiptap
  // Node with `addNodeView` so the Vue SFC takes over rendering.
